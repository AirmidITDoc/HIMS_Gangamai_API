    ...
    public class R_CommanReport : GenericRepository, I_CommanReport
    {
        ...
        public string ViewCommanDailyCollectionReceipt(DateTime FromDate, DateTime ToDate, int AddedById, int DoctorId, string htmlFilePath, string htmlHeader)
        {
                ...
                if (previousLabel != "" && previousLabel != dr["Type"].ConvertToString())
                {
                    ...
                    items.Append("<tr style='border:1px solid black;color:black;background-color:white'><td colspan='5' style=\"border-right:1px solid #000;padding:3px;height:10px;text-align:right;vertical-align:middle;margin-right:20px;font-weight:bold;\">Total</td><td style=\"border-right:1px solid #000;padding:3px;height:15px;text-align:right;vertical-align:middle\">")
                       .Append(G_BillAmount.To2DecimalPlace()).Append("</td><td style=\"border-right:1px solid #000;border-bottom:1px solid #000;padding:3px;height:10px;text-align:right;vertical-align:middle\">")
                        ...
                        .Append(G_BalanceAmt.To2DecimalPlace()).Append("</td></tr>");
            ...
            foreach (DataRow dr in Bills.Rows)
            {
                ...
                if (dr["Type"].ConvertToString() == "OP Bill")
                {

                    G_OPBillAmount += dr["BillAmount"].ConvertToDouble();
                    G_OPCashPayAmount += dr["CashPayAmount"].ConvertToDouble();
                    G_OPChequePayAmount += dr["ChequePayAmount"].ConvertToDouble();
                    G_OPCardPayAmount += dr["CardPayAmount"].ConvertToDouble();
                    G_OPNEFTPayAmount += dr["NEFTPayAmount"].ConvertToDouble();
                    G_OPPayTMAmount += dr["PayTMAmount"].ConvertToDouble();
                ...
                if (dr["Type"].ConvertToString() == "IP Bill")
                {
                    ...
                    G_BillBillAmount += dr["BillAmount"].ConvertToDouble();
                ...
                {
                    G_AdvBillAmount += dr["BillAmount"].ConvertToDouble();
                ...
                {
                    G_RefundBillAmount += dr["BillAmount"].ConvertToDouble();
                ...
                {
                    G_RefundAdvBillAmount += dr["BillAmount"].ConvertToDouble();
                    G_RefundAdvCashAmount += dr["CashPayAmount"].ConvertToDouble();
                    G_RefundAdvChequeAmount += dr["ChequePayAmount"].ConvertToDouble();
                    G_RefundAdvCardAmount += dr["CardPayAmount"].ConvertToDouble();
            ...
            T_AddBillrefundBillAmount = G_RefundBillAmount.ConvertToDouble() + G_RefundAdvBillAmount.ConvertToDouble();
        ...
        public string ViewServicewiseReportwithbill(int ServiceId, DateTime FromDate, DateTime ToDate, string htmlFilePath, string htmlHeader)
        {
            ...
            string previousLabel = "";
            string html = File.ReadAllText(htmlFilePath);
            double ServiceAmt = 0, T_NetAmount = 0;
            html = html.Replace("{{CurrentDate}}", DateTime.Now.ToString("dd/MM/yyyy hh:mm tt"));
            html = html.Replace("{{NewHeader}}", htmlHeader);
            ...
            foreach (DataRow dr in Bills.Rows)
            {
                ...
                items.Append("<tr style=\"text-align: center; border: 1px solid #d4c3c3; padding: 6px;\"><td style=\"text-align: center; border: 1px solid #d4c3c3; padding: 6px;\">").Append(i).Append("</td>");
                items.Append("<td style=\"text-align: center; border: 1px solid #d4c3c3; padding: 6px;\">").Append(dr["RegNo"].ConvertToDateString("dd/MM/yyyy")).Append("</td>");
                items.Append("<td style=\"text-align: left; border: 1px solid #d4c3c3; padding: 6px;\">").Append(dr["PatientName"].ConvertToDouble()).Append("</td>");
                items.Append("<td style=\"text-align: left; border: 1px solid #d4c3c3; padding: 6px;\">").Append(dr["ServiceName"].ConvertToDouble()).Append("</td>");
                //items.Append("<td style=\"text-align: right; border: 1px solid #d4c3c3; padding: 6px;\">").Append(dr["Price"].ConvertToDouble()).Append("</td>");
                items.Append("<td style=\"text-align: center; border: 1px solid #d4c3c3; padding: 6px;\">").Append(dr["Qty"].ConvertToDouble()).Append("</td>");
                items.Append("<td style=\"text-align: right; border: 1px solid #d4c3c3; padding: 6px;\">").Append(dr["TotalAmt"].ConvertToDouble()).Append("</td>");
                ...
                items.Append("<td style=\"text-align: right; border: 1px solid #d4c3c3; padding: 6px;\">").Append(dr["ConcessionAmount"].ConvertToDouble()).Append("</td>");
                items.Append("<td style=\"text-align: right; border: 1px solid #d4c3c3; padding: 6px;\">").Append(dr["NetAmount"].ConvertToDouble()).Append("</td></tr>");
        ...
        public string ViewServiceWiseReportWithoutBill(int ServiceId, DateTime FromDate, DateTime ToDate, string htmlFilePath, string htmlHeader)
        {
            ...
            foreach (DataRow dr in Bills.Rows)
            {
                ...
                items.Append("<td style=\"text-align: center; border: 1px solid #d4c3c3; padding: 6px;\">").Append(dr["RegNo"].ConvertToString()).Append("</td>");
                items.Append("<td style=\"text-align: left; border: 1px solid #d4c3c3; padding: 6px;\">").Append(dr["PatientName"].ConvertToString()).Append("</td>");
                items.Append("<td style=\"text-align: left; border: 1px solid #d4c3c3; padding: 6px;\">").Append(dr["AddDocName"].ConvertToString()).Append("</td>");
        ...
        public string ViewDoctorVisitAdmittedWiseGroupReport(DateTime FromDate, DateTime ToDate,int DoctorId, string htmlFilePath, string htmlHeader)
        {
            ...
            para[0] = new SqlParameter("@FromDate", FromDate) { DbType = DbType.DateTime };
            para[1] = new SqlParameter("@ToDate", ToDate) { DbType = DbType.DateTime };
            para[2] = new SqlParameter("@DoctorId", ToDate) { DbType = DbType.Int16 };
            ...
            foreach (DataRow dr in Bills.Rows)
            {
                ...
                items.Append("<td style=\"text-align: right; border: 1px solid #d4c3c3; padding: 6px;\">").Append(dr["NetPayableAmt"].ConvertToString()).Append("</td>");
                items.Append("<td style=\"text-align: left; border: 1px solid #d4c3c3; padding: 6px;\">").Append(dr["DoctorName"].ConvertToString()).Append("</td>");
                T_NetPayableAmt += dr["NetPayableAmt"].ConvertToDouble();
