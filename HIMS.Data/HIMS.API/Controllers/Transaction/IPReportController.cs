...
namespace HIMS.API.Controllers.Transaction
{
    ...
    public class IPReportController : Controller
    {
        ...
        [HttpGet("view-IPSalesBillReport")]
        public IActionResult ViewIPSalesBillReport(int OP_IP_ID, int StoreId)
        {
            string htmlFilePath = Path.Combine(_hostingEnvironment.WebRootPath, "PdfTemplates", "IPReport_IPSalesBill.html");
            string htmlHeaderFilePath = Path.Combine(_hostingEnvironment.WebRootPath, "PdfTemplates", "NewHeader.html");
            var html = _IPReports.ViewIPSalesBillReport(OP_IP_ID, StoreId,htmlFilePath, _pdfUtility.GetHeader(htmlHeaderFilePath));
            var tuple = _pdfUtility.GeneratePdfFromHtml(html, "IPSalesBillReport", "IPSalesBillReport", Wkhtmltopdf.NetCore.Options.Orientation.Portrait);


            return Ok(new { base64 = Convert.ToBase64String(tuple.Item1) });
        }

        [HttpGet("view-IPSalesBillWithReturnReport")]
        public IActionResult ViewIPSalesBillWithReturnReport(int OP_IP_ID)
        {
            string htmlFilePath = Path.Combine(_hostingEnvironment.WebRootPath, "PdfTemplates", "IPReport_IPSalesBillWithReturn.html");
            string htmlHeaderFilePath = Path.Combine(_hostingEnvironment.WebRootPath, "PdfTemplates", "NewHeader.html");
            var html = _IPReports.ViewIPSalesBillWithReturnReport(OP_IP_ID, htmlFilePath, _pdfUtility.GetHeader(htmlHeaderFilePath));
            var tuple = _pdfUtility.GeneratePdfFromHtml(html, "IPSalesBillWithReturnReport", "IPSalesBillWithReturnReport", Wkhtmltopdf.NetCore.Options.Orientation.Portrait);
        ...
        public IActionResult ViewBillSummaryReport(DateTime FromDate, DateTime ToDate)
        {
            ...
            var tuple = _pdfUtility.GeneratePdfFromHtml(html, "BillSummaryReport", "BillSummaryReport", Wkhtmltopdf.NetCore.Options.Orientation.Landscape);
        ...
        public IActionResult ViewIPDischargeTypeReport(int DoctorId, DateTime FromDate, DateTime ToDate, int DischargeTypeId)
        {
            ...
            string htmlHeaderFilePath = Path.Combine(_hostingEnvironment.WebRootPath, "PdfTemplates", "NewHeader.html");
            var html = _IPReports.ViewIPDischargeTypeReport(DoctorId, FromDate, ToDate, DischargeTypeId, htmlFilePath, _pdfUtility.GetHeader(htmlHeaderFilePath));
        ...
        public IActionResult ViewIPCreditReport(DateTime FromDate, DateTime ToDate, int RegId)
        {
            string htmlFilePath = Path.Combine(_hostingEnvironment.WebRootPath, "PdfTemplates", "IPReport_IPCreditReport.html");
            string htmlHeaderFilePath = Path.Combine(_hostingEnvironment.WebRootPath, "PdfTemplates", "NewHeader.html");
            var html = _IPReports.ViewIPCreditReport(FromDate, ToDate, RegId,  htmlFilePath, _pdfUtility.GetHeader(htmlHeaderFilePath));
        ...
        public IActionResult ViewIPDCurrentAdmittedList(DateTime FromDate, DateTime ToDate, int DoctorId, int WardId, int CompanyId)
        {
            ...
            var tuple = _pdfUtility.GeneratePdfFromHtml(html, "IPDCurrentAdmittedList", "IPDCurrentAdmittedList", Wkhtmltopdf.NetCore.Options.Orientation.Landscape);
        ...
        [HttpGet("view-IPDCurrentAdmittedDoctorWiseCharges")]
        public IActionResult ViewIPDCurrentAdmittedDoctorWiseCharges(DateTime FromDate, DateTime ToDate, int DoctorId, int WardId, int CompanyId)
        {
