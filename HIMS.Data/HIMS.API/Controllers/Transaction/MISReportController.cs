...
namespace HIMS.API.Controllers.Transaction
{
    ...
    public class MISReportController : Controller
    {
        ...
        public IActionResult ViewCityWiseIPPatientCountReport(DateTime FromDate, DateTime ToDate)
        {
            ...
            var html = _IPMIS.ViewCityWiseIPPatientCountReport(FromDate, ToDate, htmlFilePath, _pdfUtility.GetHeader(htmlHeaderFilePath));
