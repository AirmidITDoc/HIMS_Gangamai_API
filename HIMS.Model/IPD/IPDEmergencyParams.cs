   ...
   public  class IPDEmergencyParams
    {
        ...
        public IPDEmergencyRegEdit IPDEmergencyRegEdit { get; set; }
        public IPDEmergencyRegCancel IPDEmergencyRegCancel { get; set; }
    ...
    public class IPDEmergencyRegEdit
    {
        public long RegId { get; set; }
        public DateTime EmgDate { get; set; }
        public DateTime EmgTime { get; set; }
    ...
    public class IPDEmergencyRegCancel
    {
