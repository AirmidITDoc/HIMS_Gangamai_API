   ...
   public class R_IPDDischargeSummary:GenericRepository,I_IPDDischargeSummary
    {
        ...
        public string ViewDischargeSummary(DataTable Bills,int AdmissionID, string htmlFilePath, string htmlHeader)
        {
            ...
            foreach (DataRow dr in Bills1.Rows)
            {
                ...
                items.Append("<td style=\"border-left: 1px solid #d4c3c3;border-top: 1px solid #d4c3c3;border-right: 1px solid #d4c3c3; text-align: left; padding: 6px;\">").Append(dr["ItemGenericName"].ConvertToString()).Append("</td>");
        ...
        public string ViewDischargeSummaryTemplateNew(int AdmissionID, string htmlFilePath, string htmlHeader)
        {
            SqlParameter[] para = new SqlParameter[1];
