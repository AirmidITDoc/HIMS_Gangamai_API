...
namespace HIMS.Data.GSTReports
{
    public interface I_GSTReport
    {
        ...
        string ViewPurchaseGSTSummary(DateTime FromDate, DateTime ToDate, int StoreId, string htmlFilePath, string htmlHeader);
        ...
        string ViewGSTB2CSReport(DateTime FromDate, DateTime ToDate,int StoreId, string htmlFilePath, string htmlHeader);
        string ViewGSTB2GSReportConsolidated(DateTime FromDate, DateTime ToDate, int StoreId, string htmlFilePath, string htmlHeader);
