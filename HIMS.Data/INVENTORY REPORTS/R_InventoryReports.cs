...
namespace HIMS.Data.Opd
{
    public class R_InventoryReport : GenericRepository, I_InventoryReport
    {
        ...
        public string ViewGRNReturnReport(DateTime FromDate, DateTime ToDate, int StoreId, int SupplierID, string htmlFilePath, string htmlHeader)
        {
            throw new NotImplementedException();
        }
        ...
        public string ViewMaterialConsumption(DateTime FromDate, DateTime ToDate, int ToStoreId, string htmlFilePath, string htmlHeader)
        {
            throw new NotImplementedException();
        }
