...
namespace HIMS.API.Controllers.Transaction
{
    ...
    public class OPReportController : Controller
    {
        ...
        [HttpGet("view-OPDailyCollectionReceipt")]

        public IActionResult ViewOPDailyCollectionReceipt(DateTime FromDate, DateTime ToDate, int AddedById)
        {
            ...
            var tuple = _pdfUtility.GeneratePdfFromHtml(html, "OPDailyCollectionReceipt", "OPDailyCollectionReceipt"+ AddedById, Wkhtmltopdf.NetCore.Options.Orientation.Landscape);
        ...
        public IActionResult ViewCrossConsultationReport(DateTime FromDate, DateTime ToDate)
        {
            ...
            //}
            //[HttpGet("view- OPAppoinmentListWithServiseAvailed")]
            //public IActionResult ViewOPAppointmentListWithServiseAvailed(DateTime FromDate, DateTime ToDate)
            //{
            ...
            //    var tuple = _pdfUtility.GeneratePdfFromHtml(html, "OPDoctorWiseNewAndOldPatientReport", "OPDoctorWiseNewAndOldPatientReport", Wkhtmltopdf.NetCore.Options.Orientation.Portrait);
