    ...
    public class R_OPDPrescription :GenericRepository,I_OPDPrescription
    {
        ...
        public string ViewOPPrescriptionReceipt(DataTable Bills,  string htmlFilePath, string htmlHeader)
        {
            ...
            foreach (DataRow dr in Bills.Rows)
            {
                ...
                items.Append("<td style=\"padding: 6px;height:10px;vertical-align:middle;text-align:left;font-size:24px;font-weight:bold;padding-left:30px;\">").Append(dr["Instruction"].ConvertToString()).Append("</td>");
                items.Append("<td style=\"vertical-align:middle;padding: 6px;height:10px;text-align:left;font-size:24px;font-weight:bold;padding-left:30px;\">").Append(dr["TotalQty"].ConvertToString()).Append("</td></tr>");

                    if (dr["GenericName"].ConvertToString() != null)
                    {
                        items.Append("<tr style=\"font-size:18px;font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif;border: 1px;\"><td colspan=\"13\" style=\"padding:3px;height:10px;text-align:left;vertical-align:middle;padding-left:50px;\">").Append("Composition :").Append(dr["GenericName"].ConvertToString()).Append("</td></tr>");
