...
namespace HIMS.Data.GSTReports
{
    public interface I_GSTReport
    {
        ...
        string ViewPurchaseReturnGSTReportSummary(DateTime FromDate, DateTime ToDate, string htmlFilePath, string htmlHeader);
        //string ViewPurchaseGSTSummary(DateTime FromDate, DateTime ToDate, string htmlFilePath, string htmlHeader);
        string ViewSalesGSTReport(DateTime FromDate, DateTime ToDate, string htmlFilePath, string htmlHeader);
        string ViewSalesGSTDateWiseReport(DateTime FromDate, DateTime ToDate, string htmlFilePath, string htmlHeader);
        string ViewSalesReturnGSTReport(DateTime FromDate, DateTime ToDate, string htmlFilePath, string htmlHeader);
        string ViewSalesReturnGSTDateWiseReport(DateTime FromDate, DateTime ToDate, string htmlFilePath, string htmlHeader);
        //string ViewSalesGSTSummaryConsolidated(DateTime FromDate, DateTime ToDate, string htmlFilePath, string htmlHeader);
        string ViewHSNCodeWiseReport(DateTime FromDate, DateTime ToDate, string htmlFilePath, string htmlHeader);
        ...
        string ViewGSTRZAPurchaseReport(DateTime FromDate, DateTime ToDate, string htmlFilePath, string htmlHeader);
        string ViewGSTR2ASupplierWisePurchaseReport(DateTime FromDate, DateTime ToDate, string htmlFilePath, string htmlHeader);
